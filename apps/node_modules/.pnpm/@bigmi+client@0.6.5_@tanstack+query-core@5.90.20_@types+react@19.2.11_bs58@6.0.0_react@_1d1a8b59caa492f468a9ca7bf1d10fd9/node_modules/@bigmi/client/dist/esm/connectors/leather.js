import { getAddressChainId, MethodNotSupportedRpcError, ProviderNotFoundError, UserRejectedRequestError, } from '@bigmi/core';
...
export function leather(parameters = {}) {
    ...
    return createConnector((config) => ({
        ...
        async getAccounts() {
            ...
            if (shimDisconnect) {
                await config.storage?.setItem(`${this.id}.accounts`, accounts.result.addresses);
            }
